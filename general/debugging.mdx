...
<Tip>
  Use `/debug:true` — this attaches a debug file specific to your server (attached in your report) that lets us instantly spot any configuration or internal issues.
</Tip>
