...
<CardGroup cols="2">
  <Card title="Filter System" icon="filter" color="#06b6d4">
  ...
  <Card title="Dashboard Features" icon="gauge" color="#7c3aed">
    **Explore the dashboard** — Manage settings, and access server options
  </Card>
  <Card title="Log Types" icon="list" color="#22c55e">
    **Understanding logs** — Learn about all the different events Wish Logger can track
  </Card>
  <Card title="Troubleshooting" icon="helmet-safety" color="#f59e0b">
